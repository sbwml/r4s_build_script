...
[ "$version" = "snapshots-23.05" ] && git clone https://github.com/sbwml/autocore-arm -b openwrt-23.05 package/new/autocore
...
[ "$version" = "rc" ] || [ "$version" = "snapshots-23.05" ] && rm -rf package/openwrt_pkgs/ddns-scripts-dnspod
