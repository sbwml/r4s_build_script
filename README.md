  ...
  build:
    ...
    - name: Init build dependencies
      ...
      run: |
        ...
        sudo apt-get update
        sudo apt-get install -y build-essential flex bison g++ gawk gcc-multilib g++-multilib gettext git git-core libfuse-dev libncurses5-dev libssl-dev python3 python3-pip python3-ply python3-distutils rsync unzip zlib1g-dev file wget subversion patch upx-ucl autoconf automake curl proxychains-ng asciidoc binutils bzip2 libz-dev lib32gcc-s1 libc6-dev-i386 uglifyjs p7zip p7zip-full msmtp texinfo libreadline-dev libglib2.0-dev xmlto libelf-dev libtool autopoint antlr3 gperf ccache swig coreutils haveged lrzsz scons libpython3-dev
        sudo apt-get clean
